...
export class AiService {
  ...
  constructor(
    ...
    this.logger.log(
      `AI layout engine initialized (Admin: ${process.env.ADMIN_GEMINI_MODEL || process.env.GEMINI_MODEL || 'gemini-3.5-flash-lite'}, Sub-Agents: ${process.env.SUB_GEMINI_MODEL || 'gemini-3.1-flash-lite'})`,
    );
  }
