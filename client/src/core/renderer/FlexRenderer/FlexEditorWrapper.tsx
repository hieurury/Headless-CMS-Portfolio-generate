...
import FlexGridRenderer from './FlexGridRenderer';

const FlexEditorWrapper: React.FC<{
  ...
  return (
    ...
    >
      ...
      <FlexGridRenderer section={section} depth={depth} />
    </div>
  );
};

export default FlexEditorWrapper;
