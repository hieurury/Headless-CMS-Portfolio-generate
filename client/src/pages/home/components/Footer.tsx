    ...
    <footer ref={footerRef} id="home-footer" className="home-footer">
      <div className="home-footer__inner">
        ...
        <div className="home-footer__col" id="footer-nav">
          ...
          <Link to="/docs" className="home-footer__link" id="footer-docs">
            {tr.footer.links.docs}
          </Link>
          <Link
            to="/explore"
        ...
        <div className="home-footer__col" id="footer-legal">
          ...
          <a href="/terms" className="home-footer__link" id="footer-terms">
            {tr.footer.terms}
          </a>
          <a href="/privacy" className="home-footer__link" id="footer-privacy">
            {tr.footer.privacy}
          </a>
        </div>
      </div>
