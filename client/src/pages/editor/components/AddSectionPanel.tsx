        ...
        <div className="w-[260px] shrink-0 border-r border-[var(--color-border)] bg-[var(--color-surface)] flex flex-col">
          ...
          <div className="p-3 border-b border-[var(--color-border)] flex flex-col gap-0.5">
            {tabs.map((tab) => (
              ...
              >
                <tab.icon size={16} className={activeTab === tab.key ? 'text-[var(--color-bg)]' : 'text-[var(--color-text-faint)] group-hover:text-[var(--color-text)]'} />
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  {allCategories.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        <span className={clsx("opacity-50", selectedCategory === cat ? "text-[var(--color-text)]" : "group-hover:text-[var(--color-text)]")}>
                          {meta?.icon}
                        </span>
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto">
        <span className="inline-flex items-center gap-1.5 text-[10px] px-1.5 py-0.5 rounded-sm bg-[var(--color-bg)] text-[var(--color-text-muted)] border border-[var(--color-border)] font-medium shrink-0 group-hover:text-[var(--color-text)] transition-colors mb-2">
          {meta?.icon} {meta?.label}
        </span>
        <p className="text-[11px] text-[var(--color-text-faint)] leading-relaxed line-clamp-2">
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col">
        ...
        {entry.description && (
          <p className="text-[11px] text-[var(--color-text-faint)] leading-relaxed line-clamp-2 mt-auto">
            {entry.description}
          </p>
        )}
      </div>
